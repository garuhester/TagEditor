...
SelectHandler.prototype.selectRect = function (value) {
    ...
    if (this.options.points && !this.rectSelection.set.get(1)) {
        ...
        // this.rectSelection.set.add(this.nested.circle(this.options.radius).center(0, bbox.height / 2).attr('class', this.options.classPoints + '_l').on(mname, getMoseDownFunc('l')).on(ename, getMoseDownFunc('l')));
        // this.rectSelection.set.add(this.nested.rect(this.options.radius,this.options.radius).center(0, 0).attr('class', this.options.classPoints + '_lt').on(mname, getMoseDownFunc('lt')).on(ename, getMoseDownFunc('lt')));
